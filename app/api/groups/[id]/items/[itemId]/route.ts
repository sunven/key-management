...
// GET a specific item
export const GET = withAuth<{ id: string; itemId: string }>(
...
// PUT update an item
export const PUT = withAuth<{ id: string; itemId: string }>(
...
// DELETE an item
export const DELETE = withAuth<{ id: string; itemId: string }>(
  async (_request, { params, session }) => {
    const { id, itemId } = await params;
